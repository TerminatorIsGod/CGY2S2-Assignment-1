...
void Application::_Run()
{
	...
	ShaderProgram::Sptr specShad = ResourceManager::Get<ShaderProgram>(specShaderguid);
	Gameplay::Material::Sptr monkeyMat = ResourceManager::Get<Gameplay::Material>(monkMatGuid);
	Gameplay::Material::Sptr boxMat = ResourceManager::Get<Gameplay::Material>(boxMatGuid);
	Gameplay::Material::Sptr sphereMat = ResourceManager::Get<Gameplay::Material>(sphereMatGuid);
	...
	while (_isRunning) {
		...
		if (glfwGetKey(_window, GLFW_KEY_0)) {
			...
			if (!isAKeyPressed) {
				boxMat->Set("doAmbient", 1);
				monkeyMat->Set("doAmbient", 1);
				sphereMat->Set("doAmbient", 1);
			...
			if (!isAKeyPressed) {
				boxMat->Set("doAmbient", 2);
				monkeyMat->Set("doAmbient", 2);
				sphereMat->Set("doAmbient", 2);
			...
			if (!isAKeyPressed) {
				boxMat->Set("doAmbient", 3);
				monkeyMat->Set("doAmbient", 3);
				sphereMat->Set("doAmbient", 3);
			...
			if (!isAKeyPressed) {
				boxMat->Set("doAmbient", 4);
				monkeyMat->Set("doAmbient", 4);
				sphereMat->Set("doAmbient", 4);
			...
			if (!isAKeyPressed) {
				boxMat->Set("doAmbient", 5);
				monkeyMat->Set("doAmbient", 5);
				sphereMat->Set("doAmbient", 5);
				std::cout << "doAmbient set to 5" << std::endl;
			}
			isAKeyPressed = true;
		}
		else if (glfwGetKey(_window, GLFW_KEY_6)) {
			if (!isAKeyPressed) {
				if (diffRamp) {
					diffRamp = !diffRamp;
					boxMat->Set("doDiffuseRamp", 0);
					monkeyMat->Set("doDiffuseRamp", 0);
					sphereMat->Set("doDiffuseRamp", 0);
					std::cout << "doDiffuseRamp set to 0" << std::endl;
				}
				else {
					diffRamp = !diffRamp;
					boxMat->Set("doDiffuseRamp", 1);
					monkeyMat->Set("doDiffuseRamp", 1);
					sphereMat->Set("doDiffuseRamp", 1);
					std::cout << "doDiffuseRamp set to 1" << std::endl;
				}

			}
			isAKeyPressed = true;
		}
		else if (glfwGetKey(_window, GLFW_KEY_7)) {
			if (!isAKeyPressed) {
				if (specRamp) {
					specRamp = !specRamp;
					boxMat->Set("doSpecRamp", 0);
					monkeyMat->Set("doSpecRamp", 0);
					sphereMat->Set("doSpecRamp", 0);
					std::cout << "doSpecRamp set to 0" << std::endl;
				}
				else {
					specRamp = !specRamp;
					boxMat->Set("doSpecRamp", 1);
					monkeyMat->Set("doSpecRamp", 1);
					sphereMat->Set("doSpecRamp", 1);
					std::cout << "doSpecRamp set to 1" << std::endl;
				}
...
void Application::_RegisterClasses()
{
	...
	ComponentManager::RegisterType<Move>();
}
